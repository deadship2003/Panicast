...
public:
    ...
    static URLType type() { return URLType::OPML; }
    URLType supports() const override { return URLType::OPML; }
    TreeNodePtr parse(const ParseInput& in) override { return parse(in.data); }
