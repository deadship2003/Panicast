...
public:
    ...
    static std::vector<Following> fetch_followings(const std::string& sessdata, const std::string& uid,
    ...
    static std::vector<VideoInfo> fetch_user_videos(const std::string& sessdata, const std::string& mid,
                                                     int page = 1, int page_size = 50);
    ...
    static std::vector<VideoInfo> search_videos(const std::string& sessdata, const std::string& keyword,
                                                 int page = 1, int page_size = 20);

    // Y22: Fetch the logged-in user's watch history (/x/v2/history). Requires SESSDATA. No WBI.
    static std::vector<HistoryItem> fetch_history(const std::string& sessdata, int page = 1, int page_size = 50);
    ...
    static std::vector<UserInfo> search_users(const std::string& sessdata, const std::string& keyword,
                                              int page = 1, int page_size = 20);
