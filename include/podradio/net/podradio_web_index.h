...
<body>
<div class="bar"><span class="dot" id="dot"></span><b>PodRadio</b><span class="mut" id="ver"></span>
...
<div id="pinbox"><div class="c"><b>Enter PIN</b><br><span class="mut">(shown in PodRadio via :pin, or 6696)</span><br><br>
