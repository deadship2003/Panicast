...
void xml_structured_error_handler(void* ctx, xmlError* error);  // Signature strictly matches xmlStructuredErrorFunc, avoiding C-style casts
...
struct XmlDocGuard {
    ...
    operator xmlDocPtr() const { return doc; }
};
